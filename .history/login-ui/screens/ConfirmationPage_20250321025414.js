        ...
        <View style={styles.modalContainer}>
          <View style={styles.paymentModal}>
            ...
            <View style={styles.bkashHeader}>
              <Image
                source={require('../assets/bkash-logo.png')} // Make sure to add this image to your assets
        ...
        <View style={styles.modalContainer}>
          <View style={styles.successModal}>
            ...
            <Text style={styles.successDetails}>
              Your payment of {appointmentFee} BDT has been processed.
            </Text>
            ...
            >
              <Text style={styles.buttonText}>OK</Text>import React, { useEffect, useState } from 'react';
import {
  View,
  Text,
  StyleSheet,
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.successModal}>
            <Image
              source={require('../assets/success-icon.png')} // Add a checkmark or success icon
              style={styles.successIcon}
              resizeMode="contain"
            />
            <Text style={styles.successTitle}>Payment Successful!</Text>
