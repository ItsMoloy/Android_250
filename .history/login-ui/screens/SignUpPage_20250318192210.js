...
//           <TextInput style={styles.input} placeholder="Enter your email (your-email@gmail.com)" value={email} onChangeText={setEmail} keyboardType="email-address" />
...
//   overlay: { flex: 1, width: '100%', backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: 'center', alignItems: 'center' },
//   title: { fontSize: 28, fontWeight: 'bold', marginBottom: 20, color: '#fff' },
//   card: { width: '90%', backgroundColor: 'rgba(255, 255, 255, 0.9)', padding: 20, borderRadius: 12, alignItems: 'center' },
//   input: { height: 45, marginBottom: 12, paddingHorizontal: 12, borderRadius: 8, backgroundColor: '#f0f0f0', fontSize: 16, width: '100%' },
//   button: { backgroundColor: '#007bff', paddingVertical: 12, borderRadius: 8, alignItems: 'center', width: '90%', marginTop: 10 },
